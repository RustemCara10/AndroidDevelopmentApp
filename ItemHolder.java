...
public class ItemHolder extends RecyclerView.ViewHolder {
    ...
    public ItemHolder(@NonNull View itemView) {
        ...
        productNameText = itemView.findViewById(R.id.productNameTextView2);
        productPriceText = itemView.findViewById(R.id.productPriceTextView2);
        productQuantitySpinner = itemView.findViewById(R.id.spinnerQuantity2);
        quantityAddedText = itemView.findViewById(R.id.productQuantityAdded2);
        btnAddToBasket = itemView.findViewById(R.id.btnAddToBasket2);
        btnRemoveFromBasket=itemView.findViewById(R.id.btnRemoveFromBasket2);
